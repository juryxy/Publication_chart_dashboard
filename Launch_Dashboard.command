...
if command -v python3 >/dev/null 2>&1; then
  ...
  osascript -e 'display dialog "Python 3 was not found. Install Python 3.10 or newer and try again." buttons {"OK"} default button "OK" with icon stop'
  exit 1
fi
...
echo "Keep this Terminal window open while using the dashboard. Press Ctrl+C to stop it."
wait "$APP_PID"
